...
export default {
  name: 'DragAndResizable',
  props: {
    className: {
      type: String,
      default: 'drag-and-resizable',
    },
    classNameDraggable: {
      type: String,
      default: 'draggable',
  ...
  created: function() {
    if (this.maxWidth && this.minWidth > this.maxWidth) {
      console.warn(
        '[drag-and-resizable warn]: Invalid prop: minWidth cannot be greater than maxWidth'
      )
    }
    if (this.maxWidth && this.minHeight > this.maxHeight) {
      console.warn(
        '[drag-and-resizable warn]: Invalid prop: minHeight cannot be greater than maxHeight'
      )
    }
